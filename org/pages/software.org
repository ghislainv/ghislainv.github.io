#+title: Software & R/Python Packages | Ghislain Vieilledent
#+description: R and Python packages for modelling deforestation, species distribution, and tropical forest dynamics (forestatrisk, jSDM, hSDM...).
#+setupfile: setup.org

#+html_head: <meta property="og:title" content="Software & R/Python Packages | Ghislain Vieilledent"/>
#+html_head: <meta property="og:description" content="R and Python packages for modelling deforestation, species distribution, and tropical forest dynamics (forestatrisk, jSDM, hSDM...)."/>
#+html_head: <meta property="og:image" content="https://ecology.ghislainv.fr/images/banner.jpg"/>
#+html_head: <meta property="og:url" content="https://ecology.ghislainv.fr/software.html"/>
...
The Python package ~DownClim~ allows downscaling climate projections, i.e. obtaining climate projections at a high spatial resolution (≤ 1 km) from low resolution (≥ 10 km) global climate models ([[https://www.wcrp-cmip.org/][CMIP]] GCMs) or regional climate models ([[https://cordex.org/][CORDEX]] RCMs). This is done by interpolating climate anomalies and adding these anomalies to a high spatial resolution (30 arc-seconds) climatic baseline such as [[https://chelsa-climate.org/][Chelsa]] or [[https://www.worldclim.org/][WorldClim]].
https://downclim.readthedocs.io.
